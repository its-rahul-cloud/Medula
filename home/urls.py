...
urlpatterns = [
    ...
    path('blog-detail/<id>', blog_detail, name="blog_detail"),
    ...
    path("category/<slug:slug>", list_posts_by_category, name="category"),
    path("All_category/", Catagories, name="Catagories"),
]
